...
export default function Navbar() {
  ...
  function goToCart(e) {
    ...
    e.preventDefault();
    const user = JSON.parse(localStorage.getItem("user")); // أو مفتاح التسجيل اللي بتستخدمه
    if (!user) {
      // لو مش مسجل → روّحه للـ register ومعاه info عن الصفحة اللي جا منها
      ...
      <div className="fixed top-0 left-0 right-0 bg-slate-800 z-50">
        <div className="flex justify-between items-center w-full px-6 py-3">
          ...
          <div className="flex w-48 justify-around items-center">
            ...
            <button onClick={goToCart} className="relative top-1">
            ...
            <Link to="/profile">
              ...
              <Link to='/register' className="bg-blue-600 w-20 text-center rounded py-1">
              Register
              </Link>
