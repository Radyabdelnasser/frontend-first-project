    ...
    return <>
        ...
        {loading ? (
            ...
            <section className="bg-slate-700 py-8 mt-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 bg-white lg:grid-cols-5 mt-10 gap-6 p-4">
                    {products.map((item) => (
                        <div key={item.id} className="border rounded-xl shadow-md p-4 bg-gray-200">
                            ...
                            />
                            <h2 className="font-semibold mb-1">{item.title.split(" ").slice(0, 2).join(" ")}</h2>
                            ...
                            <div className="flex justify-between mt-3">
                                ...
                                <button
                                    onClick={() => addToCart(item)} // هنا بنضيفه في السلة
